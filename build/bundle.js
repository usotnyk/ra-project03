...
var _productView = __webpack_require__(17);
...
var CarouselView = function () {
  ...
  _createClass(CarouselView, [{
    ...
    key: 'createCarouselElements',
    value: function createCarouselElements() {
    ...
    value: function createCellContent(cellContainer, currentProduct) {
      ...
      var productName = this.createProductName(currentProduct);
      ...
      var quickViewButton = this.createViewButton(currentProduct);
      cellContainer.appendChild(quickViewButton);

      var cartButton = this.createCartButton(currentProduct);
...
var _checkoutView = __webpack_require__(13);
...
var CartView = function () {
  ...
  _createClass(CartView, [{
    ...
    key: 'getEachItemInCart',
    value: function getEachItemInCart(modalContainer, currentProductsInSS) {
    ...
    key: 'onClickBuildCheckout',
    value: function onClickBuildCheckout() {
      var totalPrice = this.getTotalPrice();
      ...
      cartModal.style.display = "none";
      //build checkout
      var checkoutView = new _checkoutView2.default(totalPrice);
    }
  }, {
    key: 'findProductBySku',
    value: function findProductBySku(sku) {
...
var CheckoutView = function () {
  function CheckoutView(totalPrice) {
  ...
  _createClass(CheckoutView, [{
    ...
    key: 'buildCheckout',
    value: function buildCheckout() {
      var checkoutModal = document.getElementById('checkout-modal');
      checkoutModal.style.display = "block";

      var span = document.getElementById('close-checkout');
      span.onclick = function (event) {
    ...
    key: 'renderCheckout',
    value: function renderCheckout(totalPrice) {
      var totalAmountSpan = document.getElementById('total-pay-span');
      //debugger;
    ...
    key: 'integrateStripe',
    value: function integrateStripe() {
...
var MainFunctionality = function MainFunctionality() {
  ...
  (0, _jquery2.default)(document).ready(function () {
    (0, _jquery2.default)(".smooth-scroll").on('click', function (event) {
...
var ProductView = function () {
  ...
  _createClass(ProductView, [{
    key: "buildProductView",
    value: function buildProductView() {
      this.buildModal();
    }
  }, {
    key: "buildModal",
    ...
    value: function createModalContent(modalContainer, currentProduct) {
      modalContainer.innerHTML = '';
      var newSection = document.createElement("section");
      newSection.setAttribute("class", "flex");
      modalContainer.appendChild(newSection);
      ...
      var productDescription = document.createTextNode(currentProduct.longDescription);
